								...
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{ (!empty($profilData->photo)) ? url('upload/admin_images/'.$profilData->photo) : url('upload/DCT.png')}}">
												<a class="" class=""></div>
											<div class="mr-3 my-auto">
												<h6>{{ $profilData->name }}</h6><span>{{ $profilData->email }}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="{{ route('client.profile') }}"><i class="bx bx-cog"></i>بيانات الحساب</a>
									<a class="dropdown-item" href="{{ route('client.logout') }}"><i class="bx bx-log-out"></i> تسجيل خروج </a>
								</div>
							</div>
