		...
		<div class="container-fluid">
			<div class="row no-gutter">
				...
				<div class="col-md-6 col-lg-6 col-xl-5 bg-white">
										...
										<div class="p-4 wd-100p">
											<div class="main-signin-header">
												...
												<div class="mx-auto text-center mt-4 mg-b-20">
													...
													<p class="tx-13 text-muted">Client Register</p>
												</div>
					...
					<form action="{{ route('client.register_submit') }}" method="POST" class="row g-6">
                          @csrf
						<div class="form-group">
                            <div class="mb-3">
                                <label for="exampleInputEmail" class="for-control">Resturant Name</label>
                              <input type="text" name="name" class="form-control" placeholder="Enter Name" id="name" >
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputEmail" class="for-control">Phone</label>
                              <input type="text" name="phone" class="form-control" placeholder="Enter Phone" id="phone" >
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputEmail" class="for-control">Address</label>
                          ...
                          <div class="col-12">
                            <div class="form-check">
                              <a href="{{ route('admin.forget_Password') }}">Forget Password</a>
													...
													<button type="submit" class="btn btn-main-primary btn-block">Register</button>
												</form>
											</div>
										</div>
									</div>
