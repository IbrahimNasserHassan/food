    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card mg-b-20">
                <div class="card-body">
                    <h5 class="mb-sm-0 font-size-50">Change Profilr Information</h5><br>
                    ...
                    <div class="pl-0">
                        <div class="main-profile-overview">
                            <div class="main-img-user profile-user">
                                ...
                                url('upload/DCT.png')}}"><a class="fas fa-camera profile-edit"
                    ...
                    <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                        ...
                        <div class="" id="settings">
                            ...
                            <form action="{{ route('client.profile.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <img id="showImage" alt="" src="{{ (!empty($profileData->photo)) ?
                                    url('upload/admin_images/'.$profileData->photo) : 
                                    url('upload/DCT.png')}}"
                                class="rounded-circle p-1 bg-primary" width="110">
                                    
                                <div>
                                    <a href="{{ route('client.Change_password') }}"><i class="btn btn-danger"> ! Change Paasword</i></a>
                                </div>
