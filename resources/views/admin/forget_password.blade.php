		...
		<div class="container-fluid">
			<div class="row no-gutter">
				...
				<div class="col-md-6 col-lg-6 col-xl-5 bg-white">
										...
										<div class="p-4 wd-100p">
											<div class="main-signin-header">
												...
												<div class="mx-auto text-center mt-4 mg-b-20">
													...
													<p class="tx-13 text-muted">Forget Password</p>
												</div>
                    ...
                    @endif
                    <form action="{{ route('admin.password_submit') }}" method="POST" class="row g-6">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary" type="submit">Email Password Reste link</button>
                            </div>
                        </div>
                    </form>
